           ...
           <Grid container>
             ...
             <Grid item xs={12} md={4} lg={4}>
                <Box marginBottom= '30px' marginTop='30px' >
                    <Typography  variant="h6" gutterBottom>technology used</Typography>
                    <Box width='20%' height='3px' bgcolor='green'></Box>
                      <Box sx={{display: 'flex',}}>
                         ...
                         <Stack>
                          {array.map(el => (
                            <Box sx={{display: 'flex', alignItems: 'center', margin: '8px'}}>
                                 ...
                                 <Typography fontSize= '13px'  sx={{paddingLeft: '4px'}}>{el.name}</Typography>
                            </Box>
                          ))}
                          </Stack>
                      </Box>
                      ...
                      <Box sx={{ display: 'flex', flexWrap: 'wrap'}} >
                         <Stack >
                          {arrayLogo.map(el => (
                            <Box sx={{display: 'flex', alignItems: 'center', margin: '8px'}}>
                                 <Avatar alt="Remy Sharp" src={el.image} />
                                 <Typography fontSize= '13px'  sx={{paddingLeft: '4px'}} fontWeight= '100'>{el.name}</Typography>
                            </Box>
                          ))}
                          </Stack>
                      </Box>
                ...
                <Box marginBottom= '30px' marginTop='30px'  >
                    <Typography  variant="h6" gutterBottom>shall we connect?</Typography>
                    <Box width='20%' height='3px' bgcolor='green'></Box>
                    <Stack>
                    <Box sx={{display: 'flex', alignItems: 'center', margin: '8px'}}>
                                 <Avatar alt="Remy Sharp" src={github} />
                                 <Typography fontSize= '13px'  sx={{paddingLeft: '4px'}}>Github</Typography>
                            </Box>

                            <Box sx={{display: 'flex', alignItems: 'center', margin: '8px'}}>
                                 <Avatar alt="Remy Sharp" src={linkedin} />
                                 <Typography fontSize= '13px'  sx={{paddingLeft: '4px'}}>Linkedin</Typography>
                            </Box>
                    </Stack>
                </Box>
                  ...
                  <Grid item xs={12}  md={4} lg={4}>
                <Box marginBottom= '30px' marginTop='30px'  >
                   <Typography  variant="h6" gutterBottom>All routes on the page</Typography>
                    <Box width='20%' height='3px' bgcolor='green' ></Box>
                    <Stack>
                     {['Inicio', 'Home | Cards', 'Register', 'About the page'].map(el => (
                       <Typography fontSize= '13px'  sx={{paddingLeft: '4px', marginBottom: '4px'}}>{el}</Typography>
                     ))}
