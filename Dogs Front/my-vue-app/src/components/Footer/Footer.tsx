...
const Footer = () => {
  return (
    <Box sx={{ display: 'flex', alignItems:'center', width: '100%', height: '250px' , background: '#1976d2'}}>
          <Container >
             <Box sx={{display: 'flex', justifyContent: 'space-around'}}>
                <Box sx={{width:'40%'}}>
                    <Typography color='#fff'  variant="h6" gutterBottom>technology used</Typography>
                      <Box sx={{display: 'flex'}}>
                         ...
                         <Stack>
                          {array.map(el => (
                            <Box sx={{display: 'flex', alignItems: 'center', margin: '8px'}}>
                                 ...
                                 <Typography color='#fff' sx={{paddingLeft: '4px'}}>{el.name}</Typography>
                            </Box>
                          ))}
                          </Stack>
                      </Box>
                ...
                <Box sx={{background: 'green'}}>asdsa</Box>
                <Box sx={{background: 'green'}}>asdasw</Box>
             </Box>
           </Container>
    </Box>
